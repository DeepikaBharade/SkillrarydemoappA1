...
public class WebDriverUtility 
{
	...
	/**
	 * This method is used to switch frame based on id or name
	 * @param idOrName
	 */
	...
	/**
	 * This method is used to switch frame based on frame element reference
	 * @param frameElement
	 */
	...
	/**
	 * This method is used to capture windows screenshot
	 * @param driver
	 * @param className
	 * @param jutil
	 */
	 ...
	 * @param windowID
	 */
	public void switchToWindowID(String windowID) 
	{
		driver.switchTo().window(windowID);
	}
	/**
